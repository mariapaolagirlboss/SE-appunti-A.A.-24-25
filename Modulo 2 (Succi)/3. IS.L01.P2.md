...
- **Structure of activity diagrams**:
	![[Screenshot 2025-11-14 alle 15.43.39.png|278x299]]

**INTERACTION DIAGRAMS**
- Si focalizzano su entità "reali": gli oggetti
- Specificano come gli oggetti comunicano fra di loro, in particolar modo in che ordine e con quali messaggi gli oggetti interagiscono dinamicamente durante l'esecuzione di un processo o di un'operazione.
- Due tipi di **interazioni**:
	- Time-based view
	- Organization-based view
- Un tipo di interaction diagram: **~={red}SEQUENCE DIAGRAMS=~**
	- Mostra le interazione fra oggetti organizzati secondo un ordine cronologico
	- Si focalizza su:
		- oggetti e classi
		- scambio di messaggi
	- Gli **oggetti** sono posti in una **linea orizzontale**, gli **eventi** in una **linea del tempo verticale**
	- I messaggi vanno dal **cliente** al **fornitore**
		![[Screenshot 2025-11-17 alle 10.37.54.png|244x97]]
		- **Entità**: ~={yellow}:ProfessorCourseManager=~ e ~={green}Math101-Section 1 : CourseOffering=~
		- **Linee tratteggiate verticali** sotto gli oggetti: linea temporale di esistenza dell'oggetto, il tempo scorre dall'alto verso il basso
		- ~={blue}**Add professor (professor)**=~: chiamata di metodo inviata da un oggetto all'altro. Indica che l'oggetto ~={yellow}:ProfessorCourseManager =~(**cliente**) sta chiamando il metodo ~={blue}Add professor=~ sull'oggetto ~={green}Math101-Section 1 : CourseOffering=~ (**fornitore**), passandogli un oggetto di tipo Professor come parametro
	- **Esempi**:
	![[Screenshot 2025-11-17 alle 10.28.51.png|259x127]]

	![[Screenshot 2025-11-17 alle 10.50.45.png|254x123]]
- **Cosa contiene un sequence diagram?**:
	- **Oggetti**:
		- si scambiano messaggi tra di loro
	- **Messaggi** (possono essere di 3 tipi):
		- **sincroni**: eventi di chiamata, simboleggiati dalla freccia piena
		- **asincroni**: segnali, simboleggiati dalla freccia a metà
			- 
		- messaggi "**create**" e messaggi "**destroy**"